...
//                if (m_lindex == -1)
//                {
//                    base.SetData(NativeMethods.CFSTR_FILECONTENTS, GetFileContents(m_SelectedItems));
//                }
//                else
//                {
//                    base.SetData(NativeMethods.CFSTR_FILECONTENTS, GetFileContent(m_SelectedItems, m_lindex));
...
//                FileDescriptor.dwFlags = NativeMethods.FD_WRITESTIME | NativeMethods.FD_PROGRESSUI;
...
//        }
//        private Stream GetFileContent(SelectedItem[] SelectedItems, Int32 FileNumber)
//        {
//            Debug.WriteLine("GetFileContent");
...
//                Debug.WriteLine(si.Path);

//                var fileObj = si.Context.Web.GetFileByServerRelativeUrl(si.Path);
//                var data = fileObj.OpenBinaryStream();
//                si.Context.ExecuteQuery();
//                return new ReadSeekableStream(data.Value, 1024 * 96, si.FileSize, new IDisposable[] { });
//            }
//            return null;
//        }
//        private Stream[] GetFileContents(SelectedItem[] SelectedItems)
//        {
